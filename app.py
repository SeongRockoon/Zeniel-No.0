...
<div class="app">
 ...
 <main class="stage-wrap"><div class="stage-head"><b>업무 상황판 <small style="color:#087f5b">v5.3</small></b><span id="status" class="status">변경사항 없음</span></div><div id="stage" class="stage"><img src="data:image/jpeg;base64,{{IMAGE}}"><div id="fineControl" class="fine-control"><div id="fineName" class="fine-name"></div><span></span><button class="nudge" data-dx="0" data-dy="-1">▲</button><span></span><button class="nudge" data-dx="-1" data-dy="0">◀</button><button class="nudge" data-dx="0" data-dy="1">▼</button><button class="nudge" data-dx="1" data-dy="0">▶</button><div class="fine-help">화살표 1px · Shift 5px</div></div></div></main>
...
document.addEventListener('keydown',e=>{if(!selectedId||e.target.matches('input,[contenteditable="true"]'))return;let moves={ArrowLeft:[-1,0],ArrowRight:[1,0],ArrowUp:[0,-1],ArrowDown:[0,1]};if(moves[e.key]){e.preventDefault();nudgeSelected(...moves[e.key],e.shiftKey?5:1)}})
